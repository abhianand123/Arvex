...
import dev.abhi.arvex.constants.MediaSessionConstants
...
import dev.abhi.arvex.extensions.toggleShuffleMode
...
class MediaLibrarySessionCallback @Inject constructor(
    ...
    private fun dev.abhi.arvex.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
